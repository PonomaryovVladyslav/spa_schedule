...
from schedule.models import Schedule, Procedure
...
class SlotsValidator:
    ...
    def __calculate_booked_slots(self) -> None:
        ...
        for record in self.schedule.record_set.all():
            ...
            record_end = record_start + record.procedure.time_duration
            record_start -= self.procedure.time_duration
    ...
    def ranges(self) -> list[str]:
        ...
        ranges = []
        while start <= end - self.procedure.time_duration:
